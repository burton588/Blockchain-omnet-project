...
EXECUTE_ON_STARTUP(
    ...
    e->insert(BLOCKMSG_REQ, "BLOCKMSG_REQ");
    e->insert(BLOCKMSG_FLOOD, "BLOCKMSG_FLOOD");
)

Register_Class(BlockMsg)

BlockMsg::BlockMsg(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->type = 0;
    this->nonce = 0;
}

BlockMsg::BlockMsg(const BlockMsg& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
int BlockMsg::getType() const
{
    return this->type;
}

void BlockMsg::setType(int type)
{
    this->type = type;
}

TransportAddress& BlockMsg::getSenderAddress()
{
    return this->senderAddress;
}

void BlockMsg::setSenderAddress(const TransportAddress& senderAddress)
{
...
Transactions& BlockMsg::getTransactions()
{
    return this->transactions;
}

void BlockMsg::setTransactions(const Transactions& transactions)
{
    this->transactions = transactions;
}

const char * BlockMsg::getPreviousBlockHash() const
{
    return this->previousBlockHash.c_str();
}

void BlockMsg::setPreviousBlockHash(const char * previousBlockHash)
{
...
BlockMsgDescriptor::BlockMsgDescriptor() : omnetpp::cClassDescriptor("BlockMsg", "omnetpp::cPacket")
{
...
int BlockMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "nonce")==0) return base+2;
    if (fieldName[0]=='t' && strcmp(fieldName, "transactions")==0) return base+3;
    if (fieldName[0]=='p' && strcmp(fieldName, "previousBlockHash")==0) return base+4;
    if (fieldName[0]=='c' && strcmp(fieldName, "currentBlockHash")==0) return base+5;
...
int BlockMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    BlockMsg *pp = (BlockMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *BlockMsgDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string BlockMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    BlockMsg *pp = (BlockMsg *)object; (void)pp;
    switch (field) {
        case 0: return enum2string(pp->getType(), "MessageType");
        case 1: {std::stringstream out; out << pp->getSenderAddress(); return out.str();}
        case 2: return long2string(pp->getNonce());
        case 3: {std::stringstream out; out << pp->getTransactions(); return out.str();}
        case 4: return oppstring2string(pp->getPreviousBlockHash());
        case 5: return oppstring2string(pp->getCurrentBlockHash());
        default: return "";
    }
}

bool BlockMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    BlockMsg *pp = (BlockMsg *)object; (void)pp;
    switch (field) {
        case 0: pp->setType((MessageType)string2enum(value, "MessageType")); return true;
        case 2: pp->setNonce(string2long(value)); return true;
        case 4: pp->setPreviousBlockHash((value)); return true;
        case 5: pp->setCurrentBlockHash((value)); return true;
...
const char *BlockMsgDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        ...
        case 3: return omnetpp::opp_typename(typeid(Transactions));
        default: return nullptr;
    };
}

void *BlockMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 3: return (void *)(&pp->getTransactions()); break;
        default: return nullptr;
    }
}
